...
|---|---|
| Normal install (recommended) | `FRGE.GG Setup 1.0.0.exe` |
| No-install version (USB stick / try-out) | `FRGE.GG 1.0.0.exe` (portable) |

1. Download the installer (`FRGE.GG Setup 1.0.0.exe`) from the release you were given (or the `release/` folder if you have the repo).
...
```bash
npm run dist:win     # → release/FRGE.GG Setup 1.0.0.exe  +  release/FRGE.GG 1.0.0.exe
```
