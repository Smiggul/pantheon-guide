    ...
    roles:{
            Top:    {  
              bans:["Jax","Malphite","Fiora"], replacements:["Renekton","Sett","Wukong"],
                        ...
                        coreNote: "Voltaic Cyclosword first — the lead-snowball line. Once you win the early spear trades, Voltaic's energized proc + move speed + ability haste convert that lead into repeated one-combo bursts far better than Eclipse (which is the safer alternative first item, kept in sideItems if you're not ahead). Chempunk Chainsword is almost always the correct second buy on Pantheon — his heavy AD scaling loves the flat AD + haste, and the Grievous Wounds shuts down the sustain top laners you brawl. Black Cleaver's shred keeps Conqueror trades snowballing, Sundered Sky adds the guaranteed-crit heal on Q, and Death's Dance turns extended fights into a bleed you outlast. First back after Voltaic is The Brutalizer (it now builds from Pickaxe, not Serrated Dirk, since its rework — so buy toward Brutalizer, not a dead-end Dirk); swap Plated Steelcaps / Mercury's Treads to the matchup's damage type.",
