...
export default {
  ...
  altBuilds:{
    Top:[{
      ...
      coreNote:"Skill-Capped burst-catch Volibear: Rocketbelt rush — its active dash closes the gap to land Q's stun — then Duskblade, then Zhonya's. Crucially you take Press the Attack over Lethal Tempo, playing for upfront burst instead of extended-fight DPS. Best when the enemy team is majority squishy (catch someone out of position and delete them); keep the standard Lethal Tempo attack-speed build into tanky/bruiser comps.",
