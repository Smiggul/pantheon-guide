...
const BRIAR_JGL_DEFAULT_RUNES = {
  ...
  reason:         "Conqueror stacks instantly in W Blood Frenzy and its healing amp feeds the passive's crimson-vitality healing. Last Stand is core — Frenzy drains your HP so you're always in Last Stand range. Revitalize amplifies every heal in a kit made of healing; Bone Plating covers the frenzy window where you can't path away.",
};
...
export default {
  ...
  roles:{
    Jungle:{
      ...
      corePath:"Eclipse  ›  Black Cleaver  ›  Sterak's Gage  ›  Death's Dance",
      coreNote:"Eclipse first — the % HP proc and shield both fire inside W Blood Frenzy's all-in. Black Cleaver shreds while Frenzy autos stack it instantly. Sterak's + Death's Dance third/fourth because Briar's whole design is trading her HP bar for theirs — items that stretch the bar win fights the stat-check loses. E scream is your reset button: channel to heal, release to knock back and interrupt.",
      sideItems:["Titanic Hydra","Spirit Visage","Wit's End","Maw of Malmortius","Randuin's Omen","Serylda's Grudge","Guardian Angel","Plated Steelcaps"],
      data:{
        JUGGERNAUT:{ahead:[I("Black Cleaver","Frenzy autos shred their armor in seconds."),I("Eclipse","% HP proc on their stacked health."),I("Spirit Visage","Amps passive + E healing — you out-sustain a Juggernaut.")],behind:[I("Sterak's Gage","Shield when the stat-check goes their way."),I("Spirit Visage","Healing keeps the war of attrition close."),I("Plated Steelcaps","Auto reduction on their walk-down.")],runes:{...BRIAR_JGL_DEFAULT_RUNES}},
        DIVER:{ahead:[I("Eclipse","Proc + shield wins the mirror dive."),I("Black Cleaver","Shred + haste for more E interrupts."),I("Death's Dance","Their burst becomes bleed your passive out-heals.")],behind:[I("Sterak's Gage","Survive their engage before Frenzy ramps."),I("Plated Steelcaps","Irelia/Camille chains."),I("Guardian Angel","Frenzy dives trade 1-for-1 — GA makes it profitable.")],runes:{...BRIAR_JGL_DEFAULT_RUNES}},
        ASSASSIN:{ahead:[I("Eclipse","Shield eats their opener — then Frenzy runs them down."),I("Death's Dance","Burst-to-bleed conversion beats one-shots."),I("Black Cleaver","Shred through their lethality builds.")],behind:[I("Sterak's Gage","Survive the burst — W self-frenzy can't dodge."),I("Maw of Malmortius","AP assassins — lifeline."),I("Guardian Angel","Deny the shutdown gold.")],runes:{...BRIAR_JGL_DEFAULT_RUNES}},
